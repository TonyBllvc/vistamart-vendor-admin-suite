...
const menuItems = [
  ...
  { title: "Invoices", url: "/admin/financial/invoices", icon: Receipt },
  { title: "Transactions", url: "/admin/financial/transactions", icon: FileText },
  { title: "Receipts", url: "/admin/financial/receipts", icon: Receipt },
